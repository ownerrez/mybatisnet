...
public class Generate : Statement
{
    ...
    /// </summary>
    /// <remarks>
    ///     Only used for updates. Value in updated entity is assumed to have the value after update, so where will be
    ///     current value - 1.
    /// </remarks>
    /// <example>
    ///     &lt; delete ...&gt;
    ...
    [NonSerialized] private string _rowVersion = string.Empty;
    #endregion
}