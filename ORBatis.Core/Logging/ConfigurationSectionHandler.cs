...
public class ConfigurationSectionHandler : IConfigurationSectionHandler
{
    ...
    public object Create(object parent, object configContext, XmlNode section)
    {
        ...
        if (logFactoryElementsCount > 1) throw new ConfigurationException("Only one <logFactoryAdapter> element allowed");

        if (logFactoryElementsCount == 1) return ReadConfiguration(section);
