...
public class DataReaderDecorator : IDataReader
{
    ...
    DateTime IDataRecord.GetDateTime(int i)
    {
        ...
        if (!string.IsNullOrWhiteSpace(dateTimeFormat) && _innerDataReader.GetFieldType(i) == typeof(string)) return DateTime.ParseExact(_innerDataReader.GetString(i), dateTimeFormat, CultureInfo.InvariantCulture);
