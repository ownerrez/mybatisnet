...
public class NullResultMap : IResultMap
{
    ...
    /// </summary>
    [field: NonSerialized]
    public StringCollection GroupByPropertyNames { get; } = new();

    /// <summary>
    ///     The GroupBy Properties.
    /// </summary>
    [field: NonSerialized]
    public ResultPropertyCollection GroupByProperties { get; } = new();
    ...
    /// </summary>
    [field: NonSerialized]
    public ResultPropertyCollection Parameters { get; } = new();
