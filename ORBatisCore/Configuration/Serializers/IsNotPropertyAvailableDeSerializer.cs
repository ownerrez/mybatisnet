...
public sealed class IsNotPropertyAvailableDeSerializer : IDeSerializer
{
    ...
    {
        var isNotPropertyAvailable = new IsNotPropertyAvailable(_configScope.DataExchangeFactory.AccessorFactory);

        var prop = NodeUtils.ParseAttributes(node, _configScope.Properties);
