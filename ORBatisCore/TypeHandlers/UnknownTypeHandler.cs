...
public sealed class UnknownTypeHandler : BaseTypeHandler
{
    ...
    public override void SetParameter(IDataParameter dataParameter, object parameterValue, string dbType)
    {
        ...
        {
            var handler = _factory.GetTypeHandler(parameterValue.GetType(), dbType);
    ...
    public override object GetValueByName(ResultProperty mapping, IDataReader dataReader)
    {
        ...
        if (dataReader.IsDBNull(index)) return DBNull.Value;
    ...
    public override bool Equals(object obj, string str)
    {
        ...
        var handler = _factory.GetTypeHandler(obj.GetType());
        var castedObject = handler.ValueOf(obj.GetType(), str);
