...
public sealed class EmitPropertySetAccessor : BaseAccessor, ISetAccessor
{
    ...
    private void EmitType(ModuleBuilder moduleBuilder)
    {
        ...
        var typeBuilder = moduleBuilder.DefineType("SetFor" + _targetType.FullName + _propertyName,
        ...
        var methodBuilder = typeBuilder.DefineMethod("Set",
        ...
        if (_canWrite)
        {
            ...
            var targetSetMethod = _targetType.GetMethod("set_" + _propertyName, BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly);
            ...
            if (paramType.IsValueType)
            {
                ...
                {
                    var load = (OpCode)typeToOpcode[paramType];
