...
public class ConfigurationScope : IScope
{
    ...
    /// </summary>
    public HybridDictionary SqlIncludes { get; } = new();
    ...
    ///     List of providers
    /// </summary>
    public HybridDictionary Providers { get; } = new();
    ...
    ///     IMappedStatements).
    /// </summary>
    public HybridDictionary CacheModelFlushOnExecuteStatements { get; set; } = new();
    #endregion
}