...
namespace IBatisNet.Common.Utilities.Objects.Members
{
    ...
    public sealed class DelegateFieldGetAccessor : BaseAccessor, IGetAccessor
    {
        ...
        public DelegateFieldGetAccessor(Type targetObjectType, string fieldName)
        {
            ...
            var dynamicMethodGet = new DynamicMethod("GetImplementation", typeof(object), new[] { typeof(object) }, GetType().Module, false);
            var ilgen = dynamicMethodGet.GetILGenerator();
