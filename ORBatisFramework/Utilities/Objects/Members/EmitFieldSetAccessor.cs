...
namespace IBatisNet.Common.Utilities.Objects.Members
{
    ...
    public sealed class EmitFieldSetAccessor : BaseAccessor, ISetAccessor
    {
        ...
        public EmitFieldSetAccessor(Type targetObjectType, string fieldName, AssemblyBuilder assemblyBuilder, ModuleBuilder moduleBuilder)
        {
            ...
            var fieldInfo = _targetType.GetField(fieldName, VISIBILITY);
        ...
        private void EmitType(ModuleBuilder moduleBuilder)
        {
            ...
            var typeBuilder = moduleBuilder.DefineType("SetFor" + _targetType.FullName + _fieldName, TypeAttributes.Class | TypeAttributes.Public | TypeAttributes.Sealed);
            ...
            var setMethod = typeBuilder.DefineMethod("Set",
            ...
            var targetField = _targetType.GetField(_fieldName, VISIBILITY);
            ...
            if (targetField != null)
            {
                ...
                if (_fieldType.IsValueType)
                {
                    ...
                    {
                        var load = (OpCode)typeToOpcode[_fieldType];
