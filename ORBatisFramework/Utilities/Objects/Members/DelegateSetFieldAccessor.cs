...
namespace IBatisNet.Common.Utilities.Objects.Members
{
    ...
    public sealed class DelegateFieldSetAccessor : BaseAccessor, ISetAccessor
    {
        ...
        public DelegateFieldSetAccessor(Type targetObjectType, string fieldName)
        {
            ...
            var fieldInfo = targetObjectType.GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
            ...
            var dynamicMethodSet = new DynamicMethod("SetImplementation", null, new[] { typeof(object), typeof(object) }, GetType().Module, false);
            var ilgen = dynamicMethodSet.GetILGenerator();
