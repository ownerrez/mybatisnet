...
namespace IBatisNet.Common.Utilities.Objects
{
    ...
    public sealed class DelegateFactory : IFactory
    {
        ...
        {
            var dynamicMethod = new DynamicMethod("CreateImplementation", typeof(object), new[] { typeof(object[]) }, GetType().Module, false);
            var generatorIL = dynamicMethod.GetILGenerator();

            // Emit the IL for Create method. 
            // Add test if contructeur not public
            var constructorInfo = typeToCreate.GetConstructor(VISIBILITY, null, argumentTypes, null);
