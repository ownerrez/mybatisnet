...
namespace IBatisNet.DataMapper.Configuration.Alias
{
    ...
    public class TypeAlias
    {
        ...
        public string Name
        {
            ...
            set
            {
                if (value == null || value.Length < 1) throw new ArgumentNullException("The name attribute is mandatory in the typeAlias ");
                _name = value;
            }
        }
        ...
        public string ClassName
        {
            ...
            set
            {
                if (value == null || value.Length < 1) throw new ArgumentNullException("The class attribute is mandatory in the typeAlias " + _name);
                _className = value;
            }
        }
        #endregion
