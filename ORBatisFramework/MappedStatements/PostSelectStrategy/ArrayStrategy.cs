...
namespace IBatisNet.DataMapper.MappedStatements.PostSelectStrategy
{
    ...
    public sealed class ArrayStrategy : IPostSelectStrategy
    {
        ...
        {
            var values = postSelect.Statement.ExecuteQueryForList(request.Session, postSelect.Keys);
            var elementType = postSelect.ResultProperty.SetAccessor.MemberType.GetElementType();
