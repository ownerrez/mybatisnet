...
namespace IBatisNet.DataMapper.Configuration.ResultMapping
{
    ...
    public class NullResultMap : IResultMap
    {
        ...
        /// </summary>
        [field: NonSerialized]
        public StringCollection GroupByPropertyNames { get; } = new StringCollection();

        /// <summary>
        ///     The GroupBy Properties.
        /// </summary>
        [field: NonSerialized]
        public ResultPropertyCollection GroupByProperties { get; } = new ResultPropertyCollection();
        ...
        /// </summary>
        [field: NonSerialized]
        public ResultPropertyCollection Parameters { get; } = new ResultPropertyCollection();
