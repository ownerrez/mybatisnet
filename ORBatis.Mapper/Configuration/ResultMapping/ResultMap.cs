...
namespace IBatisNet.DataMapper.Configuration.ResultMapping
{
    ...
    public class ResultMap : IResultMap
    {
        ...
        [NonSerialized] private StringCollection _groupByPropertyNames = new StringCollection();

        [NonSerialized] private ResultPropertyCollection _properties = new ResultPropertyCollection();
