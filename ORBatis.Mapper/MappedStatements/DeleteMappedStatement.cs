...
namespace IBatisNet.DataMapper.MappedStatements
{
    ...
    public sealed class DeleteMappedStatement : MappedStatement
    {
        ...
        public override Task<object> ExecuteInsertAsync(ISqlMapSession session, object parameterObject, CancellationToken cancellationToken)
        {
            throw new DataMapperException("Delete statements cannot be executed as a query insert.");
        }
        ...
        {
            throw new DataMapperException("Delete statements cannot be executed as a query for dictionary.");
        }
        ...
        {
            throw new DataMapperException("Delete statements cannot be executed as a query with row delegate.");
        }
        #endregion
    }
}