...
namespace IBatisNet.Common
{
    ...
    public class DbProvider : IDbProvider
    {
        ...
        [NonSerialized] private string _connectionAdapterClass = string.Empty;

        [NonSerialized] private IConnectionAdapter _connectionAdapter;
        ...
        {
            get => _connectionAdapterClass;
            set => _connectionAdapterClass = value;
        }
        ...
        {
            if (_templateDataAdapterIsICloneable) return (IDbDataAdapter)((ICloneable)_templateDataAdapter).Clone();
