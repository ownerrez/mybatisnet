    ...
    public class StringTokenizer : IEnumerable
    {
        ...
        public int TokenNumber
        {
            get
            {
                var count = 0;
                var currpos = 0;
                var maxPosition = _origin.Length;
        ...
        private class StringTokenizerEnumerator : IEnumerator
        {
            ...
            private string GetNext()
            {
                ...
                var nextDelimPos = _stokenizer._origin.IndexOfAny(_stokenizer._delimiters.ToCharArray(), _cursor);
                if (nextDelimPos == -1) nextDelimPos = _stokenizer._origin.Length;

                var nextToken = _stokenizer._origin.Substring(_cursor, nextDelimPos - _cursor);
