...
namespace IBatisNet.Common.Utilities.Objects.Members
{
    ...
    public sealed class EmitFieldGetAccessor : BaseAccessor, IGetAccessor
    {
        ...
        private void EmitType(ModuleBuilder moduleBuilder)
        {
            ...
            var typeBuilder = moduleBuilder.DefineType("GetFor" + _targetType.FullName + _fieldName, TypeAttributes.Class | TypeAttributes.Public | TypeAttributes.Sealed);
            ...
            var getMethod = typeBuilder.DefineMethod("Get",
